...
export function assetFileName(version, os, arch) {
    switch (os) {
        case 'macos': {
...
export function assetDirName(version, os, arch) {
    switch (os) {
        case 'macos': {
            const v = parseVersion(version);
            if (v !== null) {
...
export async function downloadNeovim(version, os, arch) {
...
export async function downloadStableNeovim(os, arch, token = null) {
    try {
...
export async function buildNightlyNeovim(os) {
